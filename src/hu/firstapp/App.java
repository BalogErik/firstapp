...
public class App {
	...
	private void run() {
		...
		if (facade.getCondition(denominator)) {
			System.out.println("A sorozatban van " + denominator + "-el osztható szám");
			System.out.println("A sorozat " + facade.getSelected(denominator) + ". eleme az!");

		} else {
			System.out.println("A sorozatban nincs " + denominator + "-el osztható szám");
		}
		denominator = 37;
		System.out.println("A sorozat " + facade.getFound(denominator) + ". eleme osztható " + denominator + "-el.");
		System.out.println("A sorozatban " + count(denominator) + " db " + denominator + "-el osztható szám van!");
